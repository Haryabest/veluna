...
class AdminScenarioStates(StatesGroup):
    ...
    communication_style_alt = State()
    opening_message = State()
    photo = State()
    edit_title = State()
    edit_title_alt = State()
    edit_story = State()
    edit_story_alt = State()
    edit_communication = State()
    edit_communication_alt = State()
    edit_opening = State()
