...
class User(Base, TimestampMixin):
    ...
    locale_selected: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
...
class Character(Base, TimestampMixin):
    ...
    name_alt: Mapped[str | None] = mapped_column(String(255), nullable=True)
    slug: Mapped[str] = mapped_column(String(255), unique=True, index=True)
    description: Mapped[str] = mapped_column(Text, default="")
    description_alt: Mapped[str | None] = mapped_column(Text, nullable=True)
    subtitle: Mapped[str | None] = mapped_column(String(255), nullable=True)
    subtitle_alt: Mapped[str | None] = mapped_column(String(255), nullable=True)
    behavior_params: Mapped[list] = mapped_column(JSONB, default=list)
    behavior_params_alt: Mapped[list] = mapped_column(JSONB, default=list)
...
class CharacterScenario(Base, TimestampMixin):
    ...
    title_alt: Mapped[str | None] = mapped_column(String(255), nullable=True)
    story: Mapped[str] = mapped_column(Text, default="")
    story_alt: Mapped[str | None] = mapped_column(Text, nullable=True)
    communication_style: Mapped[str] = mapped_column(Text, default="")
    communication_style_alt: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class Broadcast(Base, TimestampMixin):
    ...
    message_text_alt: Mapped[str | None] = mapped_column(Text, nullable=True)
